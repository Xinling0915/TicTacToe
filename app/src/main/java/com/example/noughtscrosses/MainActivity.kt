    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnUpdate.setOnClickListener({
            if (!binding.player1.text.toString().equals("") && !binding.player2.text.toString()
                ...
                binding.player1Name.setText("請玩家" + binding.player1.text.toString() + "骰骰子")
                activePlayer = 1
                gameIsActive = true
        ...
        binding.roll.setOnClickListener({
            ...
            if (rolldice == 1 && counter>0) {
                ...
                binding.player1Name.setText("玩家" + binding.player1.text.toString() + "骰子數" + player1Count)
                binding.player2Name.setText("請玩家" + binding.player2.text.toString() + "骰骰子")
            } else if (rolldice == 2 && counter>0) {
                rolldice = 0
                player2Count = counter
                binding.player2Name.setText("玩家" + binding.player2.text.toString() + "骰子數" + player2Count)
                if (player1Count > player2Count) {
                    binding.startGame.visibility = View.VISIBLE
                    binding.start.setText("由玩家" + binding.player1.text.toString() + "先開始遊戲")
                } else if (player1Count < player2Count) {
                    binding.startGame.visibility = View.VISIBLE
                    binding.start.setText("由玩家" + binding.player2.text.toString() + "先開始遊戲")
                }
            }
        })
